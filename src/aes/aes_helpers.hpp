...
namespace aes_constants
{
  ...
  constexpr size_t ctr_nonce_length = 12;
  constexpr size_t ctr_counter_length = 4;
} // namespace aes_constants
...
namespace aes_types
{
  ...
  using ilist_c_iterator = typename aes_types::ilist::const_iterator;
  using ilist_iterator = typename aes_types::ilist::iterator;

  template <size_t len>
  using iarr_c_iterator = typename aes_types::iarr<len>::const_iterator;
  template <size_t len>
  using iarr_iterator = typename aes_types::iarr<len>::iterator;
